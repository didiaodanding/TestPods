...
- (NSMutableArray <NSArray <NSDictionary *>*>*)toolInfos {
    ...
    //性能监控功能
    NSArray *performance = [self performanceInfos];
    ...
    return [[NSMutableArray alloc] initWithObjects:network ,performance, app,sandbox,log,logic,monkey,setting, expected,nil];
}
    ...
    switch(indexPath.section){
        case 0:{
            if(indexPath.row == 0){
                ...
                //webview性能查看
                LLWebViewVC *webviewVC = [[LLWebViewVC alloc] initWithStyle:UITableViewStyleGrouped] ;
        ...
        case 1:{
            if(indexPath.row==0){
                ...
                //anr 查看
                LLANRVC *anrVC = [[LLANRVC alloc] initWithStyle:UITableViewStyleGrouped] ;
                [self.navigationController pushViewController:anrVC animated:YES] ;
            }
            break ;
        }
        case 2:{
            if(indexPath.row==0){
               ...
               LLAppInfoVC *appInfoVC = [[LLAppInfoVC alloc] initWithStyle:UITableViewStyleGrouped];
                ...
                //cocos 信息查看
                LLCocosInfoVC *cocosInfoVC = [[LLCocosInfoVC alloc] initWithStyle:UITableViewStyleGrouped] ;
                 [self.navigationController pushViewController:cocosInfoVC animated:YES];
            }
            break ;
        }
        case 3:{
