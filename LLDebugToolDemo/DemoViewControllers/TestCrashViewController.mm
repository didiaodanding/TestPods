...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        cell.textLabel.text = NSLocalizedString(@"try.badmemaccess.crash",nil) ;
        cell.detailTextLabel.text = NSLocalizedString(@"crash.info", nil);
    } else if (indexPath.row == 4){
        cell.textLabel.text = NSLocalizedString(@"try.stackoverflow.crash",nil) ;
        cell.detailTextLabel.text = NSLocalizedString(@"crash.info", nil);
    } else if (indexPath.row == 5){
        cell.textLabel.text = NSLocalizedString(@"try.cpp.crash",nil) ;
        cell.detailTextLabel.text = NSLocalizedString(@"crash.info", nil);
    }
